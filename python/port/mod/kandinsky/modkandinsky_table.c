...
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(modkandinsky_draw_rect_obj, 6, 6, modkandinsky_draw_rect);
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(modkandinsky_draw_line_obj, 5, 5, modkandinsky_draw_line);
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(modkandinsky_draw_ellipse_obj, 5, 5, modkandinsky_draw_ellipse);
STATIC MP_DEFINE_CONST_FUN_OBJ_VAR_BETWEEN(modkandinsky_fill_ellipse_obj, 5, 5, modkandinsky_fill_ellipse);
...
STATIC const mp_rom_map_elem_t modkandinsky_module_globals_table[] = {
  ...
  { MP_ROM_QSTR(MP_QSTR_draw_ellipse), (mp_obj_t)&modkandinsky_draw_ellipse_obj },
  { MP_ROM_QSTR(MP_QSTR_fill_ellipse), (mp_obj_t)&modkandinsky_fill_ellipse_obj },
